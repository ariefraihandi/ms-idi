...
<body lang="EN-US" style="word-wrap: break-word">
    ...
    <div class="WordSection1">
        ...
        <p class="MsoTitle"><span lang="ms">EVIDEN TINDAK LANJUT PENGAWASAN BIDANG</span></p>
        <table>
            <tr>
            ...
            <tr>
                <th>Kondisi Akhir</th>
                <td class="colon">:</td>
                <td>{{ $pengawasan->kondisiafter }}</td>
            </tr>
            <tr>
                <th>Eviden</th>
                <td class="colon">:</td>
                <td>
                    <img src="{{ asset('eviden/' . $pengawasan->evidenafter) }}" alt="Eviden Image" width="200">
    ...
    <tr>
        ...
        <td style="width: 300px; padding-left: 20px;">
            ...
            @php
    $role = \App\Models\User::find($pengawasan->penanggung_jawab)->role;
    $title = ($role == 3) ? 'Sekretaris' : (($role == 4) ? 'Panitera' : 'Unknown Role');
@endphp

{{ $title }} {{$long_name}}

<br><br><br><br>
            {{ \App\Models\User::find($pengawasan->penanggung_jawab)->name }}
        </td>
    </tr>
    <tr>
