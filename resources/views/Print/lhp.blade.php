                ...
                @foreach ($pengawasanBidang as $pengawasan)
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="width: 80%;">{{ $pengawasan->kondisi }}</td>
                        </tr>
                        
                        <!-- Tambahkan bagian lain dari tabel sesuai kebutuhan -->
                        
                        <tr>
                            <th style="width: 20%;">Kriteria:</th>
                            <td style="width: 80%;">{{ $pengawasan->kriteria }}</td>
                        </tr>
                        
                        <tr>
                            <th style="width: 20%;">Sebab:</th>
                            <td style="width: 80%;">{{ $pengawasan->sebab }}</td>
                        </tr>
                        
                        <tr>
                            <th style="width: 20%;">Akibat:</th>
                            <td style="width: 80%;">{{ $pengawasan->akibat }}</td>
                        </tr>
                        
                        <tr>
                            <th style="width: 20%;">Rekomendasi:</th>
                            <td style="width: 80%;">{{ $pengawasan->rekomendasi }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('eviden/' . $pengawasan->eviden) }}" alt="Eviden Image" width="150"></td>
                        </tr>
                    </table>
                    <br>
                @endforeach
